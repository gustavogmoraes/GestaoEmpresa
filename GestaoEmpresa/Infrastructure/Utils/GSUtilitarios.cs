...
namespace GS.GestaoEmpresa.Solucao.Utilitarios
{
	public static class GSUtilitarios
	{
        ...
        public static IList<int> FindMissingIntegersInSequence(this IEnumerable<int> sequencia)
        {
        ...
        {
            return Culture.TextInfo.ToTitleCase(tipoDeInteracao.ToString().ToLowerInvariant()
                                                                          .Replace("_", " "))
                                   .Replace(" De ", " de ");
        }

        public static string ToCustomString(this Enum enumeration)
        {
            var stringEnum = enumeration.ToString().ToLowerInvariant().Replace("_", " ");

            return Culture.TextInfo.ToTitleCase(stringEnum)
                                   .Replace(" De ", " de ");
        }
        ...
        public static void CopyPropValuesTo(this object origin, object destiny)
        {
