...
namespace GS.GestaoEmpresa.Persistence.RavenDB
{
    public static class RavenHelper
    {
        ...
        static RavenHelper()
        {
            ...
            {
                Urls = new[] { @"http://" + SessaoSistema.InformacoesConexao.Server },
                Database = SessaoSistema.InformacoesConexao.DatabaseName
            };
        ...
        public static IDocumentSession OpenSession() => DocumentStore.OpenSession(SessaoSistema.InformacoesConexao.DatabaseName);

        public static IAsyncDocumentSession OpenAsyncSession() => DocumentStore.OpenAsyncSession(SessaoSistema.InformacoesConexao.DatabaseName);
        ...
        public static void CompactarBancoDeDados(string databaseName = null)
        {
            ...
            {
                DatabaseName = databaseName ?? SessaoSistema.InformacoesConexao.DatabaseName,
                Documents = true,
                Indexes = indexNames
            };
