...
namespace GS.GestaoEmpresa.Solucao.Negocio.Enumeradores.Seguros.Conceito
{
    public class Conceito : TypeSafeEnum<Conceito, EnumConceitos>
    {
        ...
        public static readonly Conceito Colaborador = new Conceito(EnumConceitos.COLABORADOR, "Employee");
        public static readonly Conceito Cliente = new Conceito(EnumConceitos.CLIENTE, "Client");
