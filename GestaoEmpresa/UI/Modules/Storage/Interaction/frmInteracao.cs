...
namespace GS.GestaoEmpresa.Solucao.UI.Modulos.Estoque
{
    public partial class frmInteracao : Form, IView
    {
        ...
        public frmInteracao()
        {
            ...
            InicializeBotoes(FormType.Insert, ref btnEditarSalvar, ref btnCancelarExcluir, ref _switchBotaoEditarSalvar, ref _switchBotaoCancelarExcluir);
        ...
        public frmInteracao(Interacao interacao)
        {
            ...
            DesabiliteControles();
            InicializeBotoes(FormType.Detail, ref btnEditarSalvar, ref btnCancelarExcluir, ref _switchBotaoEditarSalvar, ref _switchBotaoCancelarExcluir);
        ...
        protected void InicializeBotoes(FormType tipoDeFormType,
        ...
        public Interacao CarregueObjetoComControles()
        {
            ...
            using (var servicoDeProduto = new ProductService())
            {
                ...
                //interacao.Produto = servicoDeProduto.Query(codigoProduto, horarioProgramado, false) 
                //    ?? servicoDeProduto.Query(codigoProduto, false);
            }
        ...
        private void btnEditarSalvar_Click(object sender, EventArgs e)
        {
            switch (_switchBotaoEditarSalvar)
            {
                case EnumBotoesForm.Editar:
                    HabiliteControles();
                    InicializeBotoes(FormType.Update, ref btnEditarSalvar, ref btnCancelarExcluir, ref _switchBotaoEditarSalvar, ref _switchBotaoCancelarExcluir);
                ...
                case EnumBotoesForm.Salvar:
                    ...
                    //{
                    //    _listaDeInconsistencias = servicoDeInteracao.Save(interacao, TipoDeForm).ToList();
                    //    _codigoInteracao = interacao.Codigo;
                    //}
