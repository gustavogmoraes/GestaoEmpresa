...
{
	public abstract class RepositorioPadrao<TEntidade> : IDisposable
		where TEntidade : class, new()
	{
		...
		public Dictionary<string, PropertyInfo> Colunas
		{
            get
            {
                ...
                var listaDePropriedades = GSUtilitarios.EncontrePropriedadeMarcadaComAtributo(typeof(TEntidade), typeof(PropriedadeBD))
